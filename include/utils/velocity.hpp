...
namespace husky_inekf
{
    ...
    public:
        ...
        VelocityMeasurement(const geometry_msgs::msg::TwistStamped &vel_msg)
        {
            type_ = VELOCITY;
        ...
        void setLinearVelocity(const geometry_msgs::msg::Vector3 &lin_vel_in)
        {
        ...
        void setAngularVelocity(const geometry_msgs::msg::Vector3 &ang_vel_in)
        {
